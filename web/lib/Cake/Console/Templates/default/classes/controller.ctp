...
// ---- 2014.08.09 kobake ---- //
if(!in_array('Search.Prg', $components)){
	$components[] = 'Search.Prg';
}
if(!in_array('RequestHandler', $components)){
	$components[] = 'RequestHandler';
}
if(!in_array('App', $helpers)){
	$helpers[] = 'App';
}
// /---- 2014.08.09 kobake ---- //
...
<?php /* ---- 2014.08.09 kobake ---- */ ?>
	public $uses = array('<?php echo $defaultModel; ?>');
<?php /* /---- 2014.08.09 kobake ---- */ ?>
