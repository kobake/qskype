 ...
 */
	...
	// 2014.09.22 kobake 改行を<br/>に変換
	function h2($text, $double = true, $charset = null) {
		return preg_replace('/\n/', "<br/>\n", h($text, $double, $charset));
	}
	function h2_with_tag($text, $double = true, $charset = null) {
		$text = preg_replace('/\n/', "<br/>\n", h($text, $double, $charset));
		...
		// タグの終了
		$text = str_replace('&gt;', '>', $text); // タグの終了はすべて展開
	...
	// 2014.10.10 kobake <br>タグを残して他タグは削る
	function h3($text, $double = true, $charset = null) {
